...
saveRDS(output1, file = "Boston_performance_example")


```

```{r}
simulations = readRDS("Boston_performance_example")
...
plot.example <- cowplot::plot_grid(output1$plot_NN_performance, output1$plot_PR_vs_NN, labels = c("A", "B"), scale = 0.9, label_size = 10)
