...
```{r}
output1 = readRDS("Boston_performance_example")
...
aux <- sort(abs(colMeans(M)),decreasing = TRUE)[1:20]
...
# Save the plot in temporal file
setEPS()
postscript("temporal/fig_Boston_barplot.eps", width = 2*my_width, height = 1.5*my_width)
plot_error_bars
dev.off()
```
