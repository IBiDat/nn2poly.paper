...
Hyperbolic tangent, l1-norm constraint, 3 hidden layers, 50 neurons per layer.
...
plot.example2 <- cowplot::plot_grid(example1$plot_taylor[[1]], example1$plot_taylor[[2]], labels = c("Layer 1", "Layer 2"), scale = 0.8, label_size = 10, ncol = 1)

plot.example2

setEPS()
postscript("temporal/fig_performance_l1_tanh.eps", width = 2*my_width, height = 1*my_width)
plot.example
dev.off()

setEPS()
postscript("temporal/fig_taylor_layers_l1_tanh.eps", width = 2*my_width, height =2*my_width)
plot.example2
dev.off()
...
Softplus, l2-norm constraint, 2 hidden layers, 50 neurons per layer.
...
plot.example2 <- cowplot::plot_grid(example2$plot_taylor[[1]], example2$plot_taylor[[2]], labels = c("Layer 1", "Layer 2"), scale = 0.8, label_size = 10, ncol = 1)

plot.example2

setEPS()
postscript("temporal/fig_performance_l2_softplus.eps", width = 2*my_width, height = 1*my_width)
plot.example
dev.off()

setEPS()
postscript("temporal/fig_taylor_layers_l2_softplus.eps", width = 2*my_width, height =2*my_width)
plot.example2
dev.off()
