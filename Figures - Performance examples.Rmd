...
plot_taylor_final2 <- ggpubr::ggarrange(p1, p4, p2, p5, p3, p6, ncol=2, nrow=3, common.legend = TRUE, legend="bottom")


plot_taylor_final2

plot_taylor_final3 <- wrap_plots(wp, wp, wp, wp, wp, wp, ncol=2) + plot_layout(guides="collect")
plot_taylor_final3
```
...
```{r}
# Save as pdf
pdf(file="temporal/fig_coeffs_example1.pdf", width = 1.5*my_width, height = 1*my_width)
plot_error_bars
dev.off()
```
