...
for (k in 1:n_class){
  ...
  MSE_per_class[k] <- sum((prediction_NN_linear[,k] - prediction_poly_matrix[k,])^2) / n_test
...
saveRDS(output, file = "temporal/Covertype_max_Q_2_results")
