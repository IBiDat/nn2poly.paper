...
h_neurons_at_each_layer_vector <- c(40,70,100)
...
tic("total")
  ...
  for (L in n_hidden_layers){
    ...
    saveRDS(simulations_MSE_all_n_neurons, simulation_name)
...
# Save logs:
saveRDS(log.txt, "temporal/timelogs_MSE_loop_tanh")
